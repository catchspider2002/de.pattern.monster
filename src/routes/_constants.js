const strings = {
  ...
  description:
    "Ein einfacher Online-Mustergenerator um wiederholbare SVG-Muster zu erstellen.",
  description2: "Beschleunige Deine Website ohne Kompromisse in der Bildqualität.",
  description3: 
    "Perfekt für Webseiten-Hintergründe, Bekleidung, Branding, Verpackungsdesign und vieles mehr.",
  keywords:
